...
In order to support loading of multiple wallets in puc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is puc.cpp.
...
Changes to puc.cpp
----------------------
puc.cpp is the entry point into puc-qt, and as such, will require some minor modifications to provide hooks for
