Contributing to PowerUpCoin Core
============================

The PowerUpCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PowerUpCoin Core project, and is not to be
confused with overall PUC Network Protocol consensus changes.

Whether a pull request is merged into PowerUpCoin Core rests with the project merge
...
Patches that change PUC consensus rules are considerably more involved than
...
Where a patch set proposes to change the PUC consensus, it must have been
...
The project leader is the release manager for each PowerUpCoin Core release.
