...
#   c) node1 mines 32 blocks, so now node 0 has 60001puc, node 1 has 4250puc, node2 has none.
#   d) node0 sends 601 puc to node2, in two transactions (301 puc, then 300 puc).
