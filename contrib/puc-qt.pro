...
RESOURCES += src/qt/puc.qrc src/qt/puc_locale.qrc

TRANSLATIONS += src/qt/locale/puc_bg.ts \
                src/qt/locale/puc_de.ts \
                src/qt/locale/puc_en.ts \
                src/qt/locale/puc_es.ts \
                src/qt/locale/puc_fi.ts \
                src/qt/locale/puc_fr.ts \
                src/qt/locale/puc_it.ts \
                src/qt/locale/puc_ja.ts \
                src/qt/locale/puc_pl.ts \
                src/qt/locale/puc_pt.ts \
                src/qt/locale/puc_ru.ts \
                src/qt/locale/puc_sk.ts \
                src/qt/locale/puc_sv.ts \
                src/qt/locale/puc_vi.ts \
                src/qt/locale/puc_zh_CN.ts \
                src/qt/locale/puc_zh_TW.ts
