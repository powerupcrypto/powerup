...
QFontDatabase::addApplicationFont(":/fonts/puc_font");

QString windowTitle = tr("PowerUpCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PUC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PUC: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PowerUpCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about PowerUpCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PUC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PUC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PUC addresses"));
    ...
    openAction->setStatusTip(tr("Open a PUC: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the PowerUpCoin Core help message to get a list with possible PUC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PowerUpCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PUC network", "", count));
}
...
{
    QString strTitle = tr("PowerUpCoin Core"); // default title
