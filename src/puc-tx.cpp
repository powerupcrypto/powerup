...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PowerUpCoin Core puc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  puc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded PUC transaction") + "\n" +
                               "  puc-tx [options] -create [commands]   " + _("Create hex-encoded PUC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded PUC transaction
